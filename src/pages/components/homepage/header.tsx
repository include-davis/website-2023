...
export default function Header(): ReactElement {
    return(
        ...
        <div className={styles.main_content}>
          ...
          <p>We are a UC Davis community of web developers and designers dedicated to fostering collaboration, growth and the creation of creative digital solutions.</p>
          <button className={styles.join}>Join the community</button>

        <div className={styles.titlepg_footer}>
