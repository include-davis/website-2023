                ...
                <div className={styles.main_content}>
                    ...
                    <ul className={styles.bulletpoint}>
                        <div className={styles.grow_point}>
                            ...
                            <p> <strong>Learn:</strong> Acquire valuable skills through hands-on experiences.</p>
                        </div>
                        <div className={styles.grow_point}>
                            <img src='/homepage/edit.png' />
                            <p><strong>Create:</strong> Transform your imagination into tangible, impactful projects.</p>
                        </div>
                        <div className={styles.grow_point}>
                            <img src='/homepage/team.png' />
                            <p><strong>Connect:</strong> Forge lifelong connections and friendships with talented creatives.</p>
                        </div>
                    </ul>
                </div>
