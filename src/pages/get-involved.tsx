...
export default function GetInvolved(): React.JSX.Element {
  const boxVariant = {
    visible: { opacity: 2, scale: 1, transition: {duraction: 0.2} },
    ...
    <div>
      ...
      <section>
        <div className={styles.purpleBg}>
          <h3 className={styles.description}>We aim to provide resources and opportunities to help students <span className={styles.textGradient}>find their path</span>, no matter where they are at in their journey.</h3>
          </div>
            ...
            <div className={styles.bulletPoints}>
              ...
              <div className={styles.leftPoints}>
                ...
                <div className={styles.pointOne}>
                  ...
                  whileInView="visible">
                    <h3>Apply to join</h3>
                    <p>Become part of our cohort or <br></br>executive board</p>
                  </motion.div>
                </div>
                <div className={styles.pointThree}><motion.div
  variants={boxVariant}
  initial="hidden"
  whileInView="visible"
  >
                  <h3>Make an impact in your community</h3>
                  <p>Build things that make you proud</p></motion.div>
              </div>
  ...
  >{line}</motion.div>
              ...
              <div className={styles.pointTwo}><motion.div
  variants={boxVariant}
  initial="hidden"
  whileInView="visible"
  >
                  <h3>Work with real clients</h3>
                  <p>Get relevant industry experience</p></motion.div>
              </div>
