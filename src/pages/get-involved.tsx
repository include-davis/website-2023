...
export default function GetInvolved(): React.JSX.Element {
  ...
  const createPoint = (header: string, info: string) =>{ // used to create description w/ animation
    return (<motion.div
      variants={boxVariant}
      initial="hidden"
      whileInView="visible"
      ...
      <div className={styles.recruitmentContainer}>
        <div className={styles.recruitmentText}>
          <h2>Recruitment cycle</h2>
            <p className={styles.recruitmentInfo}> Recruitment cycle happens twice a year (Fall Quarter & Winter Quarter) for design and tech cohorts.</p>
            <p className={styles.recruitmentInfo}> Our application process typically includes a short application and an interview.</p>
            <p className={styles.recruitmentInfo}> We are always looking for motivated and dedicated individuals to
            join our team.
          </p>
        </div>
        <Image
    ...
    <section className={styles.mainContent}>
      <div className={styles.purpleBg}>
        <h3 className={styles.description}>
          ...
          <span className={styles.textGradient}>find their path</span>, no matter where they are at in their journey.
        </h3>
      </div>
      <div className={styles.whiteBg}>
        ...
        <div className={styles.bulletPoints}>
          ...
          {createPoint("Work with real clients", "Get relevant industry experience")}
          </div>
        </div>
      </div>
    </section>
